...
%
%    We keep this version in case we want to use it later. This version
%    makes the results plot together with and without bad points when
%    fitting psychometic function (as of 10/12/2023).
%
% Inputs:
%    None.
%
