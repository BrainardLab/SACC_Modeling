...
for ss = 1:numel(sineFreqCyclesPerDegTarget)
    ...
    targetScreenPrimaryContrasts = 0.10;
    targetLambda = 0.2;
...
if (STOREMEASUREMENT)
    if (ispref('SpatioSpectralStimulator','SCMDData'))
        ...
        testFilenameNew = fullfile(testFiledirNew,sprintf('targetScreenSpdMeasured_high_%s.mat',dayTimestr));
